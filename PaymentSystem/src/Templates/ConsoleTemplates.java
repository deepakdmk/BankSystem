...
public class ConsoleTemplates {
    ...
    public static final String TRANSACTION_TABLE_HEADER_FORMAT = "| %-9s | %-12s | %-4s | %7s | %8s |";
    public static final String TRANSACTION_TABLE_ROW_FORMAT = "| %-9s | %-12s | %-4s | %7.2f | %8.2f |";

    public static final String INTEREST_INTRO="Please enter interest rules details in <Date> <RuleId> <Rate in %> format (or enter blank to go back to main menu):";
    public static final String INTEREST_HEADER = "Interest rules:";
    public static final String INTEREST_TABLE_HEADER_FORMAT = "| %-9s | %-7s | %-9s |";
    public static final String INTEREST_TABLE_ROW_FORMAT = "| %-9s | %-7s | %-9.2f |";

    public static final String ERROR="Error";
    public static final String ERROR_INPUT="Enter blank to go back to main menu";
