...
public class ConsoleTemplates {
    ...
    public static final String TRANSACTION_TABLE_ROW_FORMAT = "| %-9s | %-12s | %-4s | %7.2f | %8.8f";
    ...
    public static final String ERROR_TRANSACTION_INPUT="Invalid transaction format!";
    public static final String ERROR_INVALID_TRANSACTION_NEGATIVE_BALANCE="Balance cannot go below zero.";
    public static final String ERROR_INTEREST_INPUT="Invalid interest format!";
